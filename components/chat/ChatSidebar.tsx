  ...
  return (
    <div className="flex h-full flex-col bg-[#0a0a0c]">
      ...
      <div className="px-3 pb-3 pt-2">
        {userEmail === "luisjdiazpromo@gmail.com" && (
          <button
            onClick={() => router.push("/admin")}
            className="flex min-h-[44px] w-full items-center gap-2.5 rounded-lg px-3 py-2 text-[13px] text-zinc-600 transition active:bg-white/[0.03] active:text-zinc-400"
          >
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
